    ...
    <div style={{ padding: "20px" }}>
      ...
      {isEditing ? (
        ...
        <div>
          ...
          <p><strong>Assigned To:</strong> {account.assigned_to_username}</p>
          ...
          <p><strong>Billing Address:</strong> {account.billing_street}
          <br />
          ...
          <br />
          {account.billing_postal_code}</p>
          <p><strong>Shipping Address:</strong> {account.shipping_street}
          <br />
