      ...
      <div className="OpportunityDetails_container2">
        <div style={{ padding: "20px" }}>
          ...
          {!isEditing ? (
            <div>
              <p>
                <strong>Name:</strong> {opportunity.opportunity_name}
              </p>
              <p>
                <strong>Currency:</strong> {opportunity.currency}
              </p>
              <p>
                <strong>Amount:</strong> {opportunity.opportunity_amount}
              </p>
              <p>
                <strong>Sales Stage:</strong> {opportunity.sales_stage}
              </p>
              <p>
              ...
              <p>
                <strong>Account:</strong> {opportunity.account_name}
              </p>
              <p>
              ...
              <p>
                <strong>Business Type:</strong> {opportunity.business_type}
              </p>
              <p>
                <strong>Lead Source:</strong> {opportunity.lead_source}
              </p>
              <p>
